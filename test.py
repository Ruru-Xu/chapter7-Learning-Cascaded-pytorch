...
data_path =  'dataset/Shanghai/part_A_final/test_data/images/'
gt_path = 'dataset/Shanghai/part_A_final/test_data/ground_truth'
model_path = 'dataset/Shanghai/cmtl_shtechA_204.h5'


output_dir = 'dataset/Shanghai/output/'
...
for blob in data_loader:                        
    ...
    if save_output:
        ...
        utils.save_results(density_map, gt_data, density_map, output_dir, 'put_' + blob['fname'].split('.')[0] + '.png')
